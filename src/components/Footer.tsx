...
const Footer = () => {
  return (
    <section className="w-full mt-32 p-20 flex flex-col text-center items-center gap-6 bg-yellow-400">
      ...
      <div className="flex flex-row gap-4 text-4xl bg-black py-2 px-4 w-fit rounded-md text-yellow-400">
