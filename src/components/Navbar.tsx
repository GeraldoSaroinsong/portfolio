...
const Navbar = () => {
  return (
    <section className="p-2 bg-yellow-400">
      <div className="w-[90%] md:w-3/4 m-auto flex justify-between items-center">
        ...
        >
          <span className="bg-black text-yellow-400 w-full">Sar</span>
        ...
        <a
          ...
          target="_blank"
          className="p-2 md:px-4 bg-black text-yellow-400 rounded-md text-sm md:text-lg"
        >
          Contact Me
        </a>
      </div>
